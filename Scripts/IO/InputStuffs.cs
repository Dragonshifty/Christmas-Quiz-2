...
namespace FCQ.IO
{
    public class InputStuffs : MonoBehaviour
    {
        ...
        void CheckForEmptyFields()
        {
            ...
            else if (answerZeroField.text.Equals("") || answerZeroField == null)
            {
                answerZeroField.Select();
            }
            else if (answerOneField.text.Equals("") || answerOneField == null)
            {
                answerOneField.Select();
            }
            else if (answerTwoField.text.Equals("") || answerTwoField == null)
            {
                answerTwoField.Select();
            }
            else if (answerThreeField.text.Equals("") || answerThreeField == null)
            {
                answerThreeField.Select();
            }
            else if (answerIndexField.text.Equals("") || answerIndexField == null)
            {
                answerIndexField.Select();
            }
            else
        ...
        public void DisplayOldQuestion(int index)
        {
            ...
            answerIndexField.text = (questionsList[index].answerIndex + 1).ToString();
        ...
        public void SaveEditedQuestion()
        {
            ...
            questionsList[index].answerIndex = int.Parse(answerIndexField.text) - 1;
            SaveToJson();
        }
    }
}
